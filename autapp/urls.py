...
urlpatterns = [
  ...
  path("complete/", views.complete_payment, name="pi_complete"),
    ...
    path('pi-payments/admin-resolve/', views.admin_resolve_payment, name='api_pi_admin_resolve'),
    path('pi-payments/admin-resolve-ui/', views.admin_resolve_page, name='api_pi_admin_resolve_ui'),
